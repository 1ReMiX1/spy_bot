from telegram.ext import ApplicationBuilder, CommandHandler, CallbackQueryHandler, ContextTypes, MessageHandler, PreCheckoutQueryHandler, filters
...
TOD_QUESTIONS = {
    "normal": {
        ...
        "dare": [
            ...
            "Повтори за ведущим любую фра��у с закрытым ртом.",
        ...
        try:
            await context.bot.send_message(
                ...
                text=(f"🐊 КРОКОДИЛ НАЧАЛСЯ!\n\n🎯 Сложность: {lobby.difficulty}\n"
                      ...
                      f"Остальные отправля��т боту свои варианты!")
            )
        except Exception as e:
